...
function mash_choice() {
	...
	var mash = ['', '', '', ''];  // The array of choices to pick from 
...
function fill_in_answers(answers) {
	...
	var answer_2b = document.querySelector('#answer_2b');
	...
	answer_2b.innerText = answers['answer_2b'];
	...
	answer_2b.innerHTML = answers.answer_2b;
}
